...
const HeaderV2 = () => {
  return (
    <header className="sticky top-0 z-50 flex bg-white px-4 py-2 shadow-sm">
      ...
      {/*Search bar*/}
      <form className="flex flex-1 items-center gap-2 border border-gray-200 rounded-full bg-gray-100 px-3 py-1">
        <SearchIcon className="h-6 w-6 text-gray-400" />
        <input
          type="text"
          placeholder="Search bananarama"
          className="bg-transparent flex-1 outline-none"
        />
        <button hidden />
      </form>
      {/*icons and hamburguer menu (on sm)*/}
      <div className="lg:inline-flex hidden mx-5 items-center gap-2 text-gray-500">
      ...
      {/*sign in/out */}
      <div className="hidden lg:flex flex-shrink-0 items-center cursor-pointer gap-2 border rounded-md border-gray-100 p-2">
